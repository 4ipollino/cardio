...
package com.cardio.program.bt_code;
...
import com.cardio.program.infoActivity;
...
public class DeviceConnector {
    ...
    private synchronized void setState(int state) {
        ...
        mState = state;
        mHandler.obtainMessage(infoActivity.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    // ==========================================================================
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    if (readed.contains("\n")) {
                        mHandler.obtainMessage(infoActivity.MESSAGE_READ, bytes, -1, readMessage.toString()).sendToTarget();
        ...
        public void writeData(byte[] chunk) {
            ...
            try {
                ...
                mHandler.obtainMessage(infoActivity.MESSAGE_WRITE, -1, -1, chunk).sendToTarget();
            } catch (IOException e) {
        ...
        public void write(byte command) {
            ...
            try {
                ...
                // Share the sent message back to the UI Activity
                mHandler.obtainMessage(infoActivity.MESSAGE_WRITE, -1, -1, buffer).sendToTarget();
            } catch (IOException e) {
                if (D) Log.e(TAG, "Exception during write", e);
            }
        }
